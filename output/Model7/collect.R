...
library(latex2exp)
library(hrbrthemes)
here::i_am("Model7/collect.R")
n.sim = c(20000, 50000, 100000)
b0 = c(-0.2, 0.3, 0.1)
output = c()
result = c()
for (n in n.sim) {
  filename = here("Model7", "data", paste0("Model7_n", n, ".txt"))
...
filename = here("Figure", "CP3_1.eps")
postscript(filename)
par(mar = c(2, 4, 2, 2))
p1 = ggplot(data = data,
            mapping = aes(
...
ps.options(horizontal = F)
ps.options(height = 5, width = 4)
filename = here("Figure", "CP3_2.eps")
postscript(filename)
par(mar = c(2, 4, 2, 2))
p2 = ggplot(data = data,
            mapping = aes(
...
ps.options(horizontal = F)
ps.options(height = 5, width = 4)
filename = here("Figure", "CP3_3.eps")
postscript(filename)
par(mar = c(2, 4, 2, 2))
p3 = ggplot(data = data,
            mapping = aes(
