...
library(here)
library(MASS)
here::i_am("Additional_Simulation/Model4/R_main_Add_Model4.R")
...
filename = here("Additional_Simulation","Model4", "data", paste0("Model4_n", n, ".txt"))
