...
library(latex2exp)
library(hrbrthemes)
here::i_am("Additional_Simulation/Model7/collect.R")
...
filename = here("Figure", "Addition_CP3_1.eps")
postscript(filename)
par(mar = c(2, 4, 2, 2))
p1 = ggplot(data = data,
            mapping = aes(
...
ps.options(horizontal = F)
ps.options(height = 5, width = 4)
filename = here("Figure", "Addition_CP3_2.eps")
postscript(filename)
par(mar = c(2, 4, 2, 2))
p2 = ggplot(data = data,
            mapping = aes(
...
ps.options(horizontal = F)
ps.options(height = 5, width = 4)
filename = here("Figure", "Addition_CP3_3.eps")
postscript(filename)
par(mar = c(2, 4, 2, 2))
p3 = ggplot(data = data,
            mapping = aes(
